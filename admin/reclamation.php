...
?>
          <div class="container-fluid">
            <h3 class="text-dark mb-4">Liste des réclamations</h3>
              ...
              <div class="card-header py-3">
                  <?php
                    if(isset($_POST["rep"]))
                    {
                        ...
                        $reclamationid = mysqli_real_escape_string($conn, $_POST['conid']);       
                        $updatestatus = ChangereclamationStt($conn,$reclamationid,$reponse);
              ...
              <div class="card-body">
                <div
                  ...
                  <table class="table my-0" id="dataTable">
                    ...
                    <tbody>
                      <?php $fdpdata= GetreclamationList($conn); 
                       ...
                       ?>
                        <tr>
                          ...
                          <td>
                           ...
                           } else if ($con['reponse']==0)
                           {
                            ...
                            ?> 
                            <a href="#" data-toggle="modal" data-target="#fdpsetting<?php echo $con['reclamationid']; ?>">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="fdpsetting<?php echo $con['reclamationid']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <form role="form" action="" method="post" enctype="multipart/form-data">
                              ...
                              <input type="hidden" value="<?php echo $con['reclamationid']; ?>" name="conid">
