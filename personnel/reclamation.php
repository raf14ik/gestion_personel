          ...
          <div class="section__content section__content--p30">
            <div class="container-fluid">
              ...
              if(isset($_POST["cause"]))
              {
                  ...
                  $updateStaff = Createrec( $conn,$idpersonnel, $cause);
              }
              ?>

                <div class="col-md-12">
                  <!-- DATA TABLE -->
                  <h3 class="title-5 m-b-35">Les réclamations</h3>
                  <div class="table-data__tool">
                    <div class="table-data__tool-right">
                      ...
                      >
                        <i class="zmdi zmdi-plus"></i>Envoyer une réclamation
                      </a>
                    </div>
                  </div>
                  <?php
                  ...
                  <div class="table-responsive table-responsive-data2">
                    <table class="table table-data2">
                      ...
                      <tbody>
                      <?php $congedata= GetrecList($conn,$userid); 
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Nouvelle réclamation</h5>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
