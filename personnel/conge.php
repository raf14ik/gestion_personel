          ...
          <div class="section__content section__content--p30">
            <div class="container-fluid">
              ...
              if(isset($_POST["cause"]))
              {
                  ...
                  $updateStaff = Createconge( $conn,$idpersonnel,$startDate, $finishDate, $cause);
              }
              ?>

                <div class="col-md-12">
                  <!-- DATA TABLE -->
                  <h3 class="title-5 m-b-35">Les congés</h3>
                  ...
                  <div class="table-responsive table-responsive-data2">
                    <table class="table table-data2">
                      ...
                      <tbody>
                      <?php $congedata= GetcongeList($conn,$userid); 
                        foreach($congedata as $cog) {
                    
                      ?>
                        <tr class="tr-shadow">
                          <td>
                            <span class="status--process"><?php echo $cog['datedeb']; ?></span>
                          </td>
                          <td>
                            <span class="status--process"><?php echo $cog['datefin']; ?></span>
                          </td>
                          <td>
