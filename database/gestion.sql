...
--
-- Hôte : localhost
-- Généré le : ven. 25 juin 2021 à 19:48
...
--
ALTER TABLE `fdp`
  MODIFY `fpid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `rdv`
  MODIFY `rdvid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
